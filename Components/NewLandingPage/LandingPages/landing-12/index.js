...
const Landing_12 = ({ domainInfo, pageInfo, product, visitorID }) => {
                            ...
                            <Row>
                                ...
                                <Col sm={12} md={6} lg={4}>
                                    ...
                                    <div className="SocialIconBox">
                                        ...
                                        <Link href={domainInfo?.fb ? domainInfo?.fb : "https://www.facebook.com/"} target="_blank">
                                            {" "}
                                            <BsFacebook />{" "}
                                        </Link>

                                        <Link href={domainInfo?.instagram ? domainInfo?.instagram : "https://www.instagram.com/"} target="_blank">
                                            {" "}
                                            <BsInstagram />{" "}
                                        </Link>

                                        <Link href={domainInfo?.youtube ? domainInfo?.youtube : "https://www.youtube.com/"} target="_blank">
                                            {" "}
                                            <BsYoutube />{" "}
                                        </Link>
