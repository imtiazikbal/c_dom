...
function index() {
  ...
  return (
    <>
      ...
      <div>
        <h1 style={{ background: "#894BCA", padding: "20px", color: "white", fontWeight: "600" }} align={"center"}>Terms&conditons</h1>
        <div style={{ width: "900px", margin: "50px auto" }}>
          ...
          {
            domainInfo !== undefined && domainInfo?.tos !== null && <div dangerouslySetInnerHTML={{ __html: domainInfo?.tos }} />
          }
        </div>
      </div>
    </>
